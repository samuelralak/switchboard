...
module Shared
  module Avatar
    # A deterministic identicon avatar derived from a seed string (e.g. an npub).
    # The same seed always yields the same 5x5 mirrored pixel pattern and colours,
    # so identities stay visually stable without storing or fetching any image.
    # The SVG is built with Rails tag helpers (never html_safe).
